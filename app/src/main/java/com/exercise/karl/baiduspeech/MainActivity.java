package com.exercise.karl.baiduspeech;
...
import com.exercise.karl.baiduspeech.control.InitConfig;
import com.exercise.karl.baiduspeech.listener.UiMessageListener;
import com.exercise.karl.baiduspeech.util.Auth;
import com.exercise.karl.baiduspeech.util.AutoCheck;
import com.exercise.karl.baiduspeech.util.FileUtil;
import com.exercise.karl.baiduspeech.util.IOfflineResourceConst;
...
import static com.exercise.karl.baiduspeech.util.IOfflineResourceConst.DEFAULT_OFFLINE_TTS_MODE;
import static com.exercise.karl.baiduspeech.util.IOfflineResourceConst.PARAM_SN_NAME;
import static com.exercise.karl.baiduspeech.util.IOfflineResourceConst.TEXT_MODEL;
import static com.exercise.karl.baiduspeech.util.IOfflineResourceConst.VOICE_MALE_MODEL;
...
//        setContentView(R.layout.activity_main);
    ...
    private void speak() {
        ...
        EditText editText = this.findViewById(R.id.et_input);
        String etStr = editText.getText().toString().trim();
        int result;
        if (etStr.isEmpty()) {
             result = mSpeechSynthesizer.speak("请昕煜输入文字");
        } else {
             result = mSpeechSynthesizer.speak(etStr);
        }
